...
if uploaded_file is not None:
    ...
    st.write("Preocessed Data (0 values replaced with mean):")
    ...
    if st.checkbox("Show Feature Importance"):
        ...
        if st.checkbox("Show Precision-Recal vs Threshold Curve"):
        ...
        st.write("Make a New Predcition")
        new_data = []
        ...
        if st.button("Predict"):
            precision = (model.predict_proba([new_data])[:,1] > threshold).astype(int)
